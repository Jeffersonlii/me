...
export default {
  ...
  qualifications: {
    'Technical Skills': {
      Web: {
        'HTML/CSS/JS':
          'Created a number of sites using HTML/CSS/JS, including this one!',
        Angular:
          'Worked with an Angular frontend during my time as a fullstack developer at Termerity Analytics',
        React:
          'Learned independently using official documentations and developed this personal portfolio using React',
        'Django/Django REST framwork/Django ORM':
          'Worked with the Django REST framwork backend during my time as a fullstack developer at Termerity Analytics',
        Flask:
          'Used Flask to create numerous REST apis as well as server side rendered webapps',
        'SQL/PostgreSQL/SQLite':
          'Utilized PostgreSQL during my time as a fullstack developer at Termerity Analytics',
        RxJS:
    ...
    Education: {
      ...
      'Software Engineering Specialist, Statistics Minor': 'GPA: 3.82/4.0',
    },
